...
export default function ProductDetail({ product }: { product: ProductData }) {
  ...
  return <main className="product-page">
    ...
    <footer className="contact-footer"><div><img src="/btm-logo-light.png" alt="Bhagyalaxmi Timber Mart" /><p>Complete wooden packaging solutions<br />for export & domestic use.</p></div><a href="/#products">All products <span>↗</span></a><span>© 2026 Bhagyalaxmi Timber Mart</span></footer>
  </main>;
}
