...
export default function ContactPage() {
  return <main className="contact-page">
    ...
    <section className="contact-details">
      ...
      <article><span>03 · Visit</span><h2>Find our facility</h2><p className="address">Plot No. 7508, Karmatur Cross Road,<br />GIDC Estate, Ankleshwar – 393002</p><a className="direction-link" href="https://www.google.com/maps/place/Shree+Bhagyalaxmi+Timber+Mart/@21.6146663,73.0387267,17z" target="_blank" rel="noreferrer">Open directions ↗</a></article>
    </section>

    <section className="inquiry-section"><div className="inquiry-intro"><p className="eyebrow"><span /> Request a quote</p><h2>Tell us what<br />needs protecting.</h2><p>A few useful details like cargo dimensions, weight, quantity, destination and timeline will help us respond with a more relevant recommendation.</p><div className="response-note"><strong>Industrial packaging specialists</strong><span>Wooden boxes · crates · pallets · cases · on-site packing</span></div></div><ContactForm /></section>

    <section className="map-section"><div className="map-copy"><p className="eyebrow light"><span /> Ankleshwar, Gujarat</p><h2>At the heart of<br />the industrial belt.</h2><p>Conveniently located in GIDC Estate, serving clients across Ankleshwar, Bharuch, Dahej, Jhagadia and throughout Gujarat.</p></div><div className="map-frame"><iframe title="Shree Bhagyalaxmi Timber Mart location in Ankleshwar" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3709.2631725676647!2d73.03872667696965!3d21.614666280185336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be023e690d70849%3A0x5121227f7d377c04!2sShree%20Bhagyalaxmi%20Timber%20Mart!5e0!3m2!1sen!2sin!4v1789039261088!5m2!1sen!2sin" loading="lazy" allowFullScreen referrerPolicy="strict-origin-when-cross-origin" /></div></section>

    <footer className="contact-footer"><div><img src="/btm-logo-light.png" alt="Bhagyalaxmi Timber Mart" /><p>Complete wooden packaging solutions<br />for export & domestic use.</p></div><a href="/">Back to home <span>↗</span></a><span>© 2026 Bhagyalaxmi Timber Mart</span><p className="footer-credit">Designed and developed by <a href="https://www.instagram.com/bigartstudio?utm_source=qr&igsi=bDFhem1yc29leTRn" target="_blank" rel="noreferrer">BigArts Studio</a></p></footer>
  </main>;
}
